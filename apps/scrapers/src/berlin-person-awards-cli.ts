...
例:
  pnpm scrapers berlin-person-awards --dry-run
  pnpm scrapers berlin-person-awards --year 2025
  pnpm scrapers berlin-person-awards --category "Silver Bear for Best Director"
`,
    )
    .action(
      async (options: {

...
export function createCommand(): Command {
  return new Command()
    ...
    .addHelpText(
      ...
      `
例:
  pnpm scrapers cannes-film-festival
  pnpm scrapers cannes-film-festival --year 2024
  pnpm scrapers cannes-film-festival --winners-only
  pnpm scrapers cannes-film-festival --year 2024 --winners-only
  pnpm scrapers cannes-film-festival --dry-run
`,
    )
    .action(
      async (options: {

...
例:
  pnpm scrapers academy-person-awards --dry-run
  pnpm scrapers academy-person-awards --year 2026
  pnpm scrapers academy-person-awards --category "Academy Award for Best Director"
`,
    )
    .action(
      async (options: {

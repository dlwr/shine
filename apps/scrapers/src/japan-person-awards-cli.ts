...
例:
  pnpm scrapers japan-person-awards --dry-run
  pnpm scrapers japan-person-awards --award blue-ribbon --year 2025
  pnpm scrapers japan-person-awards --award mainichi --category 監督賞
`,
    )
    .action(
      async (options: {

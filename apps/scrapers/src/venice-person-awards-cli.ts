...
例:
  pnpm scrapers venice-person-awards --dry-run
  pnpm scrapers venice-person-awards --year 2025
  pnpm scrapers venice-person-awards --category "Silver Lion for Best Director"
`,
    )
    .action(
      async (options: {

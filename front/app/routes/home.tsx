/* eslint-disable @typescript-eslint/no-explicit-any, unicorn/no-null, unicorn/prevent-abbreviations, unicorn/prefer-global-this, unicorn/catch-error-name, unicorn/consistent-function-scoping */
...
export default function Home({ loaderData }: Route.ComponentProps) {
  const { movies: initialMovies, error: initialError, locale, apiUrl, shouldFetchOnClient } = loaderData as {
    movies: any;
    error: string | null;
    locale: string;
    apiUrl: string;
...
function Movies({
  ...
  const [reselectLoading, setReselectLoading] = useState<Record<string, boolean>>({});
